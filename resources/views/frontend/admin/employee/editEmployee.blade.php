    ...
    <div class="card">
        ...
        <input type="hidden" class="form-control" id="id" name="id" value="{{$employee->id}}">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="other_id_name">ID Type:</label>
                        <select class="form-control" id="other_id_name" name="other_id_name">
                            <option value="">--select--</option>
                            <option value="Singapore Citizen" @if($employee->other_id_name == 'Singapore Citizen') selected @endif>Singapore Citizen</option>
                            <option value="Permanent Residence" @if($employee->other_id_name == 'Permanent Residence') selected @endif>Permanent Residence</option>
                            <option value="S Pass" @if($employee->other_id_name == 'S Pass') selected @endif>S Pass</option>
                            <option value="Work Permit" @if($employee->other_id_name == 'Work Permit') selected @endif>Work Permit</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
